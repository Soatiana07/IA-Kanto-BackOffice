<%-- 
    Document   : liste_Contenu
    Created on : 5 mai 2023, 11:12:50
    Author     : Kanto
--%>
<%@page import="java.util.*"%>
<%@ page import="model.*" %>
<% ArrayList<V_contenu> listContenu = (ArrayList<V_contenu>) request.getAttribute("listContenu");
%>
<!doctype html>
<html lang="en">
    ...
    <head>
        ...
        <title>Liste_Intelligence_Artificielle</title>
                        ...
                        <div class="col-lg-4  col-12 mb-4 mb-lg-0">
                            <div class="custom-block custom-block-overlay">
                                ...
                                <div class="custom-block-info custom-block-overlay-info">
                                    ...
                                    <form  action="formulaireModifier" method="post">
                                        <input type="hidden" name="id" value="<%=listContenu.get(i).getId()%>">
            ...
            <div class="col-lg-4 col-12 mx-auto">
                <nav aria-label="Page navigation example">
                    <ul class="pagination pagination-lg justify-content-center mt-5">
                        <%if (offset > 0) {%>
                        <li class="page-item">
                            <a class="page-link" href="listeContenu?offset=<%= offset - limite%>&limit=<%= limite%>" aria-label="Previous">
                        ...
                        <li class="page-item">
                            <a class="page-link" href="listeContenu?offset=<%= offset + limite%>&limit=<%= limite%>" aria-label="Next">

<%-- 
    ...
    Created on : 7 mai 2023, 18:08:19
    Author     : Kanto
--%>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="Intelligence_Artificielle/listeContenu?limite=2&offset=0">Liste</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <form action="insertContenu" method="post" class="custom-form contact-form" role="form">
                            <div class="row">
                                <div class="col-lg-6 col-8">
                                    ...
                                    <div class="form-floating">
                                        <input type="password" name="mdp" id="name" class="form-control"
